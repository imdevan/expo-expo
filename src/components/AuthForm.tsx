        ...
        <View className="space-y-4">
          <Field name="email">
            {({ input, meta }) => (
              <View>
                <TextInput
                  className={cn(`bg-input p-4 rounded-lg text-base ${
                ...
                {meta.error && meta.touched && (
                  <ThemedText className="text-error text-xs mt-1">{meta.error}</ThemedText>
                )}
              </View>
            )}
          </Field>
          ...
          <Field name="password">
            {({ input, meta }) => (
              <View>
                <TextInput
                  className={`bg-input bg-black p-4 rounded-lg text-base ${
                    meta.error && meta.touched ? 'border border-error' : ''
                  }`}
          ...
          {error && (
            <ThemedText className="text-error text-xs mt-1">
              {error.message}
            </ThemedText>
          )}

          <TouchableOpacity
            className="bg-primary p-4 rounded-lg items-center mt-2.5"
